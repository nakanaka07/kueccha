...
const isLogLevelEnabled = (level) => {
    ...
    if (level === 'error')
        levelPriority = LOG_LEVEL_PRIORITY.error;
    else if (level === 'warn')
        levelPriority = LOG_LEVEL_PRIORITY.warn;
    else if (level === 'info')
        levelPriority = LOG_LEVEL_PRIORITY.info;
    else if (level === 'debug')
        levelPriority = LOG_LEVEL_PRIORITY.debug;
    if (currentLevel === 'error')
        currentPriority = LOG_LEVEL_PRIORITY.error;
    else if (currentLevel === 'warn')
        currentPriority = LOG_LEVEL_PRIORITY.warn;
    else if (currentLevel === 'info')
        currentPriority = LOG_LEVEL_PRIORITY.info;
    else if (currentLevel === 'debug')
        currentPriority = LOG_LEVEL_PRIORITY.debug;
