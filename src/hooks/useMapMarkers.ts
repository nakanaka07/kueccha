...
export function useMapMarkers({
  ...
  animateMarkers = true,
  // 環境変数の設定を優先する
  enableClustering = ENV.features.markerClustering,
  ...
  }, [mapRef, pois, currentPoiIdSet, createOrUpdateMarker, enableClustering, clusterer]); // clustererを依存配列に追加
  ...
  }, [clusterer]); // clustererのみを依存配列に含める
