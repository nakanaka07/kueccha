...
const App: React.FC = () => {
    const initialAreaVisibility = useMemo(() => Object.values(AREAS).reduce((acc, areaName) => {
        acc[areaName] = true;
        return acc;
    ...
    const filteredPois = useMemo(() => pois.filter(poi => areaVisibility[AREAS[poi.area]]), [pois, areaVisibility]);
