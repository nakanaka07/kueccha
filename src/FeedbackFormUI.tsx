...
export const FeedbackFormUI: React.FC<FeedbackFormUIProps> = ({
  ...
  return (
    <form onSubmit={onSubmit} noValidate>
      ...
      <label htmlFor="email">
        メール:
        <input id="email" type="email" value={email} onChange={onEmailChange} aria-label="メール" />
      </label>
      <label htmlFor="message">
        メッセージ:
        <textarea id="message" value={message} onChange={onMessageChange} aria-label="メッセージ" />
      </label>
